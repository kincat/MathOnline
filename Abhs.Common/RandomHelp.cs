...
namespace Abhs.Common
{
    public class RandomHelp
    {
        ...
        /// 生成随机数
        /// </summary>
        /// <param name="min">起始(包含)</param>
        /// <param name="max">结束(包含)</param>
        /// <returns></returns>
        ...
        /// 主要用来生成消息的创建时间
        /// </summary>
        /// <param name="day">某天</param>
        /// <param name="startHour"></param>
        /// <param name="endHour"></param>
        /// <returns></returns>
        public static DateTime GetRandomDateTime(int day, int startHour, int endHour)
        {
            Random random = new Random((int)(DateTime.Now.Ticks));

            int hour = random.Next(startHour, endHour);
            int minute = random.Next(1, 52);
